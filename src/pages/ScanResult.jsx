...
import { RotateCcw, Plus, Share2, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen px-4 pt-6 pb-24 max-w-2xl mx-auto">
      ...
      <div className="mt-6 space-y-4">
        ...
        <div className="flex gap-3 sticky bottom-0 pb-4 bg-gradient-to-t from-black to-transparent pt-4">
          ...
          >
            {enriching ? <Loader2 size={16} className="animate-spin" /> : <Plus size={16} />} {enriching ? 'Adding...' : 'Add to Collection'}
          </button>
