  ...
  return (
    <div className="space-y-1">
      ...
      <input
        ...
        aria-label={label}
        className="w-full h-1.5 rounded-full appearance-none bg-white/10 accent-amethyst cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:ring-offset-2 ring-offset-background"
      />
  ...
  return (
    <div className="min-h-screen px-4 pt-6 pb-24 max-w-2xl mx-auto">
      ...
      <div className="mb-6">
        <GlassPanel className="p-4" style={{ borderColor: 'hsla(160,70%,45%,0.22)' }}>
          ...
          <div className="ml-9 space-y-4">
            ...
            <div>
              <label htmlFor="privacy-level-select" className="block text-xs text-white/50 uppercase tracking-[0.2em] font-mono mb-2">Location Privacy Level</label>
              <PrivacySelectSheet id="privacy-level-select" value={settings.privacyLevel} onChange={(v) => handleChange('privacyLevel', v)} />
            </div>
            ...
            {[
              ...
              <label key={key} className="flex items-center gap-3 text-sm text-white/60 cursor-pointer py-1">
                <input
                  ...
                  className="w-4 h-4 rounded border-white/30 accent-amethyst focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:ring-offset-2 ring-offset-background"
                />
                {label}
              </label>
            ))}
        ...
        <GlassPanel className="p-4">
          ...
          <div className="ml-9 space-y-2">
            ...
            <button
              ...
              className="text-xs text-amethyst-glow/70 hover:text-amethyst-glow mt-1 transition disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:ring-offset-2 ring-offset-background rounded-sm"
            >
          ...
          <div className="ml-9 space-y-5">
            ...
            <div className="flex gap-3 pt-1">
              <button onClick={saveVoice}
                className="flex-1 py-2.5 rounded-xl font-semibold text-white text-sm transition active:scale-95 select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:ring-offset-2 ring-offset-background"
              ...
              <button onClick={resetVoice}
                className="px-4 py-2.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-white/50 text-sm transition select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:ring-offset-2 ring-offset-background">
                Reset
              </button>
            </div>
          </div>
      ...
      <button onClick={saveSettings}
        className="w-full py-3.5 rounded-2xl font-black text-white text-sm transition active:scale-95 select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:ring-offset-2 ring-offset-background"
