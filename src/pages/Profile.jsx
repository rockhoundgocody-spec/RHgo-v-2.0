        ...
        <GlassPanel className="p-5 flex items-center gap-4">
          ...
          <div className="relative flex-shrink-0">
            <button
              ...
              disabled={uploading}
              className="w-14 h-14 rounded-full bg-amethyst/15 border border-amethyst/30 flex items-center justify-center overflow-hidden relative group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:ring-offset-2 ring-offset-background"
          ...
          <div className="flex-1 min-w-0">
            ...
            <button
              onClick={() => fileInputRef.current?.click()}
              className="text-[10px] text-amethyst-glow/70 hover:text-amethyst-glow mt-1 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:ring-offset-2 ring-offset-background rounded px-1"
            >
