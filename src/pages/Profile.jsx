      ...
      <div className="mb-8">
        <GlassPanel className="p-5 flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <button
              onClick={() => fileInputRef.current?.click()}
              className="text-[10px] text-amethyst-glow/70 hover:text-amethyst-glow mt-1 transition focus-visible:outline-none focus-visible:underline focus-visible:ring-2 focus-visible:ring-amethyst/50 rounded px-1"
            >
