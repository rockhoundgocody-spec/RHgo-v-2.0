  ...
  return (
    <div className="flex flex-col items-center gap-1 -mt-6 px-1 select-none">
      <motion.button
        onClick={onClick}
        whileTap={{ scale: 0.92 }}
        className="relative flex items-center justify-center cursor-pointer focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:outline-none focus-visible:ring-offset-2 ring-offset-background"
        style={{
          width: 58,
          height: 58,
          borderRadius: '50%',
