...
export default function DiscoveryChoiceModal({
  open,
  mineralName,
  onClose,
  onConfirm,
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(180deg, hsl(250 20% 12%) 0%, hsl(248 22% 7%) 100%)",
              border: "1px solid hsla(270,50%,60%,0.25)",
              boxShadow:
                "0 12px 60px hsla(250,60%,3%,0.8), inset 0 1px 0 hsla(270,60%,90%,0.08)",
            }}
          >
            ...
            <div className="mt-4 flex items-start gap-2.5">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setConfirmedLegal(checked === true)
                }
              ...
              <Label
                ...
                className="text-white/55 text-[11px] leading-snug font-normal cursor-pointer select-none"
              >
                <ShieldCheck
                  size={12}
                  className="inline mr-1 text-emerald-400"
                />
                I had legal access to this location and followed local
                collecting rules. Never collect where prohibited — when in
                doubt, mark in place.
              </Label>
            </div>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: canConfirm
                  ? "0 4px 24px hsla(280,80%,50%,0.35)"
                  : "none",
              }}
            >
              Confirm Discovery
...
function ChoiceCard({
  ...
  const c =
    accent === "cyan"
      ? {
          icon: "hsl(195,100%,75%)",
          border: "hsla(195,90%,60%,0.55)",
          glow: "hsla(195,100%,60%,0.25)",
        }
      : {
          icon: "hsl(280,85%,80%)",
          border: "hsla(280,80%,65%,0.55)",
          glow: "hsla(280,100%,65%,0.25)",
        };
  return (
    <button
      onClick={onClick}
