...
import { Sparkles, RotateCcw, GitCompare, Pencil, Microscope, CheckCircle2, Zap, FlaskConical, BookOpen, Star, Shield, Cloud } from 'lucide-react';
      ...
      <div className="mt-3 rounded-2xl overflow-hidden" style={{ background: 'hsla(220,40%,5%,0.7)', border: '1px solid hsla(270,30%,25%,0.3)' }}>
        ...
        {activeTab === 'tests' && (
          <div id="result-panel-tests" role="tabpanel" aria-labelledby="result-tab-tests" tabIndex={0} className="p-4 space-y-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-amethyst-glow">
            ...
            {/* Deep analysis CTA — routes to the working Deep tab */}
            <button
