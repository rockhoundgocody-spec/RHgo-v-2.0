...
const RARITY_CFG = {
  common: {
    label: "Common",
    color: "#94a3b8",
    glow: "hsla(215,20%,55%,0.5)",
    border: "hsla(215,20%,55%,0.3)",
    badge: "bg-slate-500/20 text-slate-300 border-slate-500/30",
  },
  uncommon: {
    label: "Uncommon",
    color: "#34d399",
    glow: "hsla(160,70%,50%,0.5)",
  ...
  rare: {
    label: "Rare",
    color: "#38bdf8",
    glow: "hsla(200,90%,60%,0.55)",
    border: "hsla(200,90%,60%,0.4)",
    badge: "bg-sky-500/20 text-sky-300 border-sky-500/30",
  },
  legendary: {
    label: "Legendary",
    color: "#a78bfa",
    glow: "hsla(270,80%,65%,0.65)",
    border: "hsla(270,80%,65%,0.5)",
    badge: "bg-amethyst/20 text-amethyst-glow border-amethyst/40",
  },
};
  ...
  return (
    <>
        ...
        >
          ...
          >
            ...
            >
              {primaryImageUrl ? (
                ...
                <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
                  <Sparkles
                    size={48}
                    style={{ color: rc.color, opacity: 0.4 }}
                  />
                </div>
              )}
              ...
              <div
                ...
                style={{
                  background: `radial-gradient(circle at 50% 40%, ${rc.glow} 0%, transparent 65%)`,
                }}
              />
              {/* Scan lines */}
              <div
                ...
                style={{
                  backgroundImage:
                    "repeating-linear-gradient(0deg, hsla(195,100%,70%,0.4) 0 1px, transparent 1px 4px)",
                }}
              />
            </div>
            ...
            <div className="absolute top-3 left-3 z-10">
              <span
                className={`text-[10px] font-bold uppercase tracking-[0.25em] px-2.5 py-1 rounded-full border ${rc.badge}`}
              >
                {rc.label}
              </span>
            </div>
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(0deg, hsla(220,60%,4%,0.95) 0%, transparent 100%)",
              }}
            >
              <div
                className="text-2xl font-black text-white leading-tight"
                style={{ textShadow: `0 0 30px ${rc.glow}` }}
              >
      ...
      <div className="mt-3 flex gap-2">
        {!saved ? (
          <Button
            ...
            style={{
              background: `linear-gradient(135deg, hsla(270,80%,40%,0.9), hsla(280,100%,55%,0.7))`,
              border: `1px solid ${rc.border}`,
      ...
      <div
        ...
        style={{
          background: "hsla(220,40%,6%,0.8)",
          border: "1px solid hsla(270,30%,30%,0.25)",
        }}
      >
        {TABS.map(({ id, icon: Icon, label }) => (
          <button
            ...
            style={{
              background:
                activeTab === id ? `hsla(270,60%,30%,0.5)` : "transparent",
      ...
      <div
        ...
        style={{
          ...
          border: "1px solid hsla(270,30%,25%,0.3)",
        }}
      >
        {/* ID TAB */}
        {activeTab === "id" && (
          <div className="p-4 space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {candidates.map((c, i) => (
                    ...
                    >
                      <div className="text-[10px] font-mono text-white/30 w-4">
                        {i + 1}
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-white/40 text-[10px] mt-0.5 line-clamp-1">
                          {c.rationale || c.features}
                        </div>
                      </div>
                      <div
            ...
            {result?.collection_value && (
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, ${rc.glow.replace("0.5", "0.08")}, transparent)`,
                  border: `1px solid ${rc.border}`,
                }}
              >
                <div
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                { label: "Value Estimate", value: result?.value_estimate },
                {
                  label: "Image Quality",
                  value:
                    result?.image_quality_score != null
                      ? `${Math.round(result.image_quality_score * 100)}%`
                      : null,
                },
              ]
                ...
                .map((row, i) => (
                  <div
                    ...
                    style={{
                      ...
                      border: "1px solid hsla(270,20%,20%,0.3)",
                    }}
                  >
          ...
          <div className="p-4 space-y-3">
            {tests.length === 0 && (
              <p className="text-white/30 text-sm text-center py-6">
                No verification tests available.
              </p>
            )}
            {tests.map((t, i) => (
              <div
                ...
                style={{ border: "1px solid hsla(270,20%,25%,0.35)" }}
              >
                <div
                  className="px-3 py-2.5 flex items-start gap-3"
                  style={{ background: "hsla(220,40%,7%,0.7)" }}
                >
                  <div
          ...
          <div className="p-4 space-y-4">
            ...
            {result?.fun_fact && (
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, hsla(270,50%,15%,0.5), hsla(220,40%,8%,0.6))`,
                  border: `1px solid ${rc.border}`,
                }}
              >
                <div
