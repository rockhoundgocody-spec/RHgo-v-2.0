          ...
          >
            ...
            <div className="overflow-y-auto px-5 pb-8" style={{ maxHeight: 'calc(85vh - 20px)' }}>
              <div className="flex items-center justify-between mb-5">
                <h2 id={titleId} className="text-lg font-black text-white">Log a Trip</h2>
                <button
                  type="button"
                  onClick={onClose}
                  aria-label="Close"
              ...
              <div className="space-y-4">
                ...
                <Field label="Mood">
                  <div className="flex flex-wrap gap-2" role="group" aria-label="Trip mood selector">
                    {MOODS.map((m) => (
                      <button
                        key={m.value}
                        type="button"
                ...
                <button
                  ...
                  title={!form.expedition_name.trim() ? 'Enter a trip name to log' : undefined}
