            ...
            <div className="overflow-y-auto px-5 pb-8" style={{ maxHeight: 'calc(85vh - 20px)' }}>
              <div className="flex items-center justify-between mb-5">
                ...
                <button
                  onClick={onClose}
                  aria-label="Close"
                  className="w-8 h-8 rounded-full flex items-center justify-center focus-visible:ring-2 focus-visible:ring-amethyst-glow/60 focus-visible:outline-none"
              ...
              <div className="space-y-4">
                <Field label="Trip Name" htmlFor="capsule-expedition-name">
                  <input
                    id="capsule-expedition-name"
                    type="text"
                ...
                <Field label="Story (optional)" htmlFor="capsule-story">
                  <textarea
                    id="capsule-story"
                    value={form.story}
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded-2xl font-black text-white text-sm transition active:scale-95 disabled:opacity-40 focus-visible:ring-2 focus-visible:ring-amethyst-glow/60 focus-visible:outline-none"
