  ...
  return (
    <>
      ...
      <button
        ...
        className="w-10 h-10 rounded-full flex items-center justify-center bg-amethyst/20 border border-amethyst/40 text-amethyst-glow hover:bg-amethyst/30 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-hud-cyan/50 focus-visible:ring-offset-2 ring-offset-background"
        ...
        <>
          ...
          <div className="fixed right-0 top-0 bottom-0 z-50 w-full max-w-sm bg-gradient-to-b from-amethyst-deep/40 to-black border-l border-amethyst/20 shadow-2xl">
            ...
            <div className="flex items-center justify-between p-6 border-b border-white/10">
              ...
              <button
                onClick={() => setIsOpen(false)}
                className="p-1 hover:bg-white/10 rounded-lg transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-hud-cyan/50 focus-visible:ring-offset-2 ring-offset-background"
              ...
              {menuItems.map((item, i) => {
                ...
                return (
                  <button
                    key={i}
                    onClick={item.action}
                    className="w-full flex items-center justify-between p-3 rounded-lg hover:bg-white/10 transition text-white group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-hud-cyan/50 focus-visible:ring-offset-2 ring-offset-background"
                  >
