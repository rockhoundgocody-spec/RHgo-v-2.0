  ...
  return (
    <>
      ...
      <button
        ...
        aria-label={user?.full_name ? `User menu for ${user.full_name}` : "User Profile Menu"}
        title={user?.full_name || "User Profile Menu"}
      >
        <User size={18} />
      </button>
        ...
        <>
          ...
          <div className="fixed right-0 top-0 bottom-0 z-50 w-full max-w-sm bg-gradient-to-b from-amethyst-deep/40 to-black border-l border-amethyst/20 shadow-2xl">
            ...
            <div className="flex items-center justify-between p-6 border-b border-white/10">
              ...
              <button
                onClick={() => setIsOpen(false)}
                className="p-1 hover:bg-white/10 rounded-lg transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:ring-offset-2 ring-offset-background"
