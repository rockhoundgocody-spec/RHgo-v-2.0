    ...
    >
      ...
      {(ctaLabel && (ctaTo || ctaOnClick)) && (
        ctaTo ? (
          <Link
            to={ctaTo}
            className="px-6 py-3 rounded-2xl font-bold text-white text-sm transition active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst-glow/60 focus-visible:ring-offset-2 focus-visible:ring-offset-space-black"
            style={{
