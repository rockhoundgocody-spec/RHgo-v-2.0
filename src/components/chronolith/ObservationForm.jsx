...
export function buildObservationsPayload(values, freeText, presetFields = PRESET_FIELDS) {
  const observations = [];
...
function ObservationHeader({ onClose }) {
  return (
...
function SuggestedPrompt({ suggestedTest }) {
...
function ObservationSubmitButton({ onSubmit, loading }) {
  return (
...
export default function ObservationForm({ open, onClose, onSubmit, loading, suggestedTest }) {
  ...
  const handleSubmit = () => {
    const observations = buildObservationsPayload(values, freeText);
      ...
      {open && (
        <>
          ...
          >
            ...
            <ObservationHeader onClose={onClose} />

            <SuggestedPrompt suggestedTest={suggestedTest} />
            ...
            <ObservationSubmitButton onSubmit={handleSubmit} loading={loading} />
          </motion.div>
        </>
      )}
    </AnimatePresence>
