    ...
    >
      ...
      >
        ...
        <div className="relative px-6 pt-8 pb-4 text-center"
          ...
          <button onClick={onClose} aria-label="Close" className="absolute top-3 right-3 text-white/40 hover:text-white/80 transition focus-visible:ring-2 focus-visible:ring-orange-400/50 focus-visible:ring-offset-2 ring-offset-background focus-visible:outline-none rounded-full">
            <X size={16} />
          </button>
        ...
        <div className="px-4 pb-6">
          <button
            onClick={handleShare}
            className="w-full py-3 rounded-2xl font-black text-sm uppercase tracking-[0.2em] flex items-center justify-center gap-2 transition-all active:scale-95 focus-visible:ring-2 focus-visible:ring-orange-400/50 focus-visible:ring-offset-2 ring-offset-background focus-visible:outline-none"
          ...
          <div className="flex gap-2 pb-4">
            {claimed ? (
              <div className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-emerald-400 text-xs font-bold"
                ...
                <button onClick={() => setShowMeme(true)} aria-label="Share challenge results" className="ml-1 text-white/40 hover:text-white/70 transition focus-visible:ring-2 focus-visible:ring-orange-400/50 focus-visible:ring-offset-2 ring-offset-background focus-visible:outline-none rounded-md">
                  <Share2 size={11} />
                </button>
              </div>
            ) : (
              <button onClick={claim}
                className="flex-1 py-2.5 rounded-xl text-xs font-bold uppercase tracking-[0.2em] transition-all active:scale-95 focus-visible:ring-2 focus-visible:ring-orange-400/50 focus-visible:ring-offset-2 ring-offset-background focus-visible:outline-none"
            ...
            <button
              ...
              aria-label="Spin challenge roulette"
              className="px-4 py-2.5 rounded-xl text-xs font-bold uppercase tracking-[0.15em] transition-all active:scale-95 disabled:opacity-40 focus-visible:ring-2 focus-visible:ring-orange-400/50 focus-visible:ring-offset-2 ring-offset-background focus-visible:outline-none"
