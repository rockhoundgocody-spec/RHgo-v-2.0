    ...
    >
      ...
      >
        ...
        <div className="relative px-6 pt-8 pb-4 text-center"
          ...
          <button onClick={onClose} aria-label="Close" className="absolute top-3 right-3 text-white/40 hover:text-white/80 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400/50 rounded-full">
            <X size={16} />
          </button>
        ...
        <div className="px-4 pb-6">
          <button
            onClick={handleShare}
            className="w-full py-3 rounded-2xl font-black text-sm uppercase tracking-[0.2em] flex items-center justify-center gap-2 transition-all active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400/50"
          ...
          <div className="flex gap-2 pb-4">
            {claimed ? (
              <div className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-emerald-400 text-xs font-bold"
                ...
                <button onClick={() => setShowMeme(true)} aria-label="Share" className="ml-1 text-white/40 hover:text-white/70 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400/50 rounded-full p-0.5">
                  <Share2 size={11} />
                </button>
              </div>
            ) : (
              <button onClick={claim}
                className="flex-1 py-2.5 rounded-xl text-xs font-bold uppercase tracking-[0.2em] transition-all active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400/50"
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl text-xs font-bold uppercase tracking-[0.15em] transition-all active:scale-95 disabled:opacity-40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-400/50"
