      ...
      <div className="px-4 pt-4 pb-3 border-b border-white/5">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-4 py-3 rounded-xl bg-amethyst-deep hover:bg-amethyst disabled:opacity-30 text-white transition flex items-center gap-1.5 text-sm font-medium shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:ring-offset-2 ring-offset-background"
          >
        ...
        <div className="flex gap-1.5 mt-2 flex-wrap">
          {EXAMPLE_COMMANDS.slice(0, 3).map((ex, i) => (
            <button
              ...
              className="text-[10px] px-2 py-1 rounded-full border border-white/10 text-white/40 hover:text-white/70 hover:border-amethyst/30 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:ring-offset-2 ring-offset-background"
            >
              {ex}
            </button>
          ))}
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  className="text-white/30 hover:text-white/60 transition shrink-0 mt-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 rounded-lg"
                >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border border-amethyst/30 text-amethyst/80 hover:text-white hover:bg-amethyst/10 text-xs font-medium uppercase tracking-[0.25em] transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:ring-offset-2 ring-offset-background"
              >
