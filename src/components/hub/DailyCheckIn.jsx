  ...
  return (
    <GlassPanel className="mb-10 p-5">
      ...
      <div className="flex gap-2 flex-wrap mb-4">
        {moods.map((m) => (
          <button
            ...
            className={`min-h-[44px] px-3.5 py-2 rounded-full border text-sm transition-all focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:outline-none ${
              picked === m.key
      ...
      <button
        ...
        className="mt-4 w-full min-h-[44px] inline-flex items-center justify-center gap-2 rounded-lg border border-amethyst/40 bg-amethyst/15 hover:bg-amethyst/25 disabled:opacity-40 disabled:cursor-not-allowed text-amethyst-glow text-xs uppercase tracking-[0.3em] transition focus-visible:ring-2 focus-visible:ring-amethyst/50 focus-visible:outline-none"
      >
        {submitting ? (
          <>
