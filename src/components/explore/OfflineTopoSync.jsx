      ...
      {cacheSize !== null && cacheSize > 0 && (
        <div className="flex items-center gap-2 mb-3 px-3 py-2 rounded-xl"
          ...
          <button
            ...
            className="ml-auto text-white/30 hover:text-rose-400 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-400/50 rounded-sm"
          >
            <Trash2 size={11} />
          </button>
        </div>
        ...
        <>
          {showConfirm ? (
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl text-xs font-bold text-white transition active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-hud-cyan/50"
                ...
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl text-xs font-semibold text-white/50 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl text-xs font-bold text-white transition active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-hud-cyan/50"
