...
// Nearest-neighbour TSP from origin using a single-pass O(N) minimum scan per step
// to avoid expensive O(N log N) sorting and redundant distance evaluations.
