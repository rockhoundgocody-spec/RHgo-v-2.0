...
function Chip({ active, onClick, icon: Icon, children, title }) {
  return (
    <button
      ...
      aria-pressed={active}
      className={cn(
        'flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-[11px] uppercase tracking-wider border transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-hud-cyan/50 focus-visible:ring-offset-2 ring-offset-background',
        active
