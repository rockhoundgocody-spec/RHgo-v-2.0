    ...
    <GlassPanel className="p-0 overflow-hidden">
      ...
      {isFind && post.mineral_name && (
        <div className="mx-4 mb-3 p-3 rounded-xl flex items-center gap-3"
          ...
          <div className="w-10 h-10 rounded-lg flex items-center justify-center text-lg" style={{ background: `${rarityColor}1a` }}>🪨</div>
          <div>
        ...
        <div className="px-4 pb-4 space-y-2 border-t border-white/5 pt-3">
          ...
          <div className="flex items-center gap-2 pt-1">
            <input value={commentText} onChange={e => setCommentText(e.target.value)}
              ...
              className="flex-1 text-[11px] text-white/80 placeholder-white/25 outline-none px-2 py-1.5 rounded-lg focus-visible:ring-2 focus-visible:ring-amethyst-glow/50"
