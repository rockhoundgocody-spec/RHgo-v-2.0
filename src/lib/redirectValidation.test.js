...
import { isValidRedirectTarget } from '../../base44/functions/createCheckoutSession/redirectValidation.ts';
...
describe('isValidRedirectTarget', () => {
  it('allows valid base44 app origins', () => {
    ...
    expect(isValidRedirectTarget('https://sub.rhgo2.base44.app/page')).toBe(true);
  });
  ...
  it('rejects unapproved external domains or unauthorized base44 app subdomains', () => {
    ...
    expect(isValidRedirectTarget('https://evil.base44.app/phish')).toBe(false);
    expect(isValidRedirectTarget('https://otherapp.base44.app/login')).toBe(false);
  });
