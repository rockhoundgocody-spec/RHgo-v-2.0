...
type RuleApplied = 'confidence_capped_unverified' | 'confidence_capped_low_context' | 'expert_review_required' | 'value_estimate_withheld' | 'rarity_flagged_low_context' | 'safety_escalation';
